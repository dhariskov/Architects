...
from architects.projects import views
from architects.projects.views import ProjectsListView, ProjectDetailsView, ProjectCreateView, MoreProjectDetailsView, \
